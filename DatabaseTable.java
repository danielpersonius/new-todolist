...
public class DatabaseTable {
    ...
    private static class DatabaseOpenHelper extends SQLiteOpenHelper {
        ...
        public long addItem(String name, short complete) {
            ContentValues initialValues = new ContentValues();
            initialValues.put(COL_NAME, name);
            initialValues.put(COL_COMPLETE, complete);
    ...
    private Cursor query(String selection, String[] selectionArgs, String[] columns){
        ...
        Cursor cursor = builder.query(mDatabaseOpenHelper.getReadableDatabase(), columns, selection, selectionArgs, null, null, null, null);
